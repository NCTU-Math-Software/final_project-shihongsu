...
***
* 
  1. There's only __one__ program to be run, and it will output __the requested number__, as well as __the square of the number__ to check the result is indeed correct.
